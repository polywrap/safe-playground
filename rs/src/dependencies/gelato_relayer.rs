...
const WRAP_INFO: &[u8] = include_bytes!("../../../wrap-dependencies/gelato-relayer/wrap.info");
const WRAP_WASM: &[u8] = include_bytes!("../../../wrap-dependencies/gelato-relayer/wrap.wasm");
